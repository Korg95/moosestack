...
async function findConfigFile(startDir = process.cwd()) {
  ...
  while (true) {
    const configPath = path4.join(currentDir, "moose.config.toml");
...
// src/dmv2/internal.ts
var isClientOnlyMode = () => process3.env.MOOSE_CLIENT_ONLY === "true";
...
//# sourceMappingURL=browserCompatible.mjs.map